...
public final class user_002dlockout_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    if (flag != null) {
      ...
      if (_jspx_eval_fmt_message_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_fmt_param_0.setValue( "<b><a href='user-properties.jsp?username="+URLEncoder.encode(username, "UTF-8")+"'>"+JID.unescapeNode(username)+"</a></b>" );
 ...
 if (LockOutManager.getLockOutProvider().isDelayedStartSupported()) { 
      ...
      if (_jspx_meth_fmt_message_21(_jspx_page_context))
        return;
      out.write(" <input type=\"text\" size=\"5\" maxlength=\"10\" name=\"starydelay_custom\" /> ");
